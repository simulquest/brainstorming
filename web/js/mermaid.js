// js/mermaid.js - Génération du graphique Mermaid à partir du résumé.
// Version web : mermaid vient du CDN (window.mermaid), pas de npm.
...
const getMermaid = () => {
  ...
  if (!m) {
    throw new Error('Mermaid CDN non chargé. Vérifiez la connexion internet.');
  }
  if (!mermaidReady) {
